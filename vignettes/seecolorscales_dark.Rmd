...
vignette: >
  %\VignetteIndexEntry{seecolorscalesdark}
...
There are several different [color scales available](https://easystats.github.io/see/reference/index.html#section-scales) in the *see* package, most of them having some pre-defined palettes like `"full"`, `"ice"`, `"rainbow"`, `"complement"`, `"contrast"`, or `"light"` - exceptions are the [pizza color scale](https://easystats.github.io/see/reference/scale_color_pizza.html) and [bluebrown color scale](https://easystats.github.io/see/reference/scale_color_blubrown.html).

In this vignettes, we show the `"light"` palettes for the different color scales to give an impression how these scales work with different type of data, especially for *dark themes*.
