...
\
`model`` ``<-`` `[`glm`](https://rdrr.io/r/stats/glm.html)`(``vs`` ``~`` ``wt`` ``+`` ``mpg``, data ``=`` ``mtcars``, family ``=`` ``"binomial"``)`\
`result`` ``<-`` `[`binned_residuals`](https://easystats.github.io/performance/reference/binned_residuals.html)`(``model``)`\
`result`\
...
\
`model`` ``<-`` `[`suppressWarnings`](https://rdrr.io/r/base/warning.html)`(`[`glm`](https://rdrr.io/r/stats/glm.html)`(``am`` ``~`` ``mpg`` ``+`` ``vs`` ``+`` ``cyl``, data ``=`` ``mtcars``, family ``=`` ``"binomial"``)``)`\
`result`` ``<-`` `[`binned_residuals`](https://easystats.github.io/performance/reference/binned_residuals.html)`(``model``)`\
`result`\
...
\
`m`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``mpg`` ``~`` ``wt`` ``+`` ``cyl`` ``+`` ``gear`` ``+`` ``disp``, data ``=`` ``mtcars``)`\
`result`` ``<-`` `[`check_collinearity`](https://easystats.github.io/performance/reference/check_collinearity.html)`(``m``)`\
\
`result`\
...
`Salamanders``$``cover2`` ``<-`\
`  ``Salamanders``$``cover`` ``*`` `[`runif`](https://rdrr.io/r/stats/Uniform.html)`(``n ``=`` `[`nrow`](https://rdrr.io/r/base/nrow.html)`(``Salamanders``)``, min ``=`` ``0.7``, max ``=`` ``1.5``)`\
\
...
`)`\
\
`result`` ``<-`` `[`check_collinearity`](https://easystats.github.io/performance/reference/check_collinearity.html)`(``model``)`\
\
`result`\
`#> # Check for Multicollinearity`\
`#> `\
...
`mt1`` ``<-`` ``mtcars``[``, `[`c`](https://rdrr.io/r/base/c.html)`(``1``, ``3``, ``4``)``]`\
`# create some fake outliers and attach outliers to main df`\
`mt2`` ``<-`` `[`rbind`](https://rdrr.io/r/base/cbind.html)`(``mt1``, `[`data.frame`](https://rdrr.io/r/base/data.frame.html)`(``mpg ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``37``, ``40``)``, disp ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``300``, ``400``)``, hp ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``110``, ``120``)``)``)`\
`# fit model with outliers`\
`model`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``disp`` ``~`` ``mpg`` ``+`` ``hp``, data ``=`` ``mt2``)`\
`result`` ``<-`` `[`check_outliers`](https://easystats.github.io/performance/reference/check_outliers.html)`(``model``)`\
\
`result`\
...
\
`model2`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``mpg`` ``~`` ``wt`` ``+`` ``cyl`` ``+`` ``gear`` ``+`` ``disp``, data ``=`` ``mtcars``)`\
`result2`` ``<-`` `[`check_normality`](https://easystats.github.io/performance/reference/check_normality.html)`(``model2``)`
...
`result`` ``<-`` `[`check_normality`](https://easystats.github.io/performance/reference/check_normality.html)`(``model``, effects ``=`` ``"random"``)`\
[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(``result``)`\
`#> [[1]]`
...
\
`model`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``mpg`` ``~`` ``wt`` ``+`` ``cyl`` ``+`` ``gear`` ``+`` ``disp``, data ``=`` ``mtcars``)`\
`result`` ``<-`` `[`check_heteroscedasticity`](https://easystats.github.io/performance/reference/check_heteroscedasticity.html)`(``model``)`\
[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(``result``)`
...
\
`model`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``len`` ``~`` ``supp`` ``+`` ``dose``, data ``=`` ``ToothGrowth``)`\
`result`` ``<-`` `[`check_homogeneity`](https://easystats.github.io/performance/reference/check_homogeneity.html)`(``model``)`\
[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(``result``)`
...
\
`model`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``mpg`` ``~`` ``wt`` ``+`` ``cyl`` ``+`` ``gear`` ``+`` ``disp``, data ``=`` ``mtcars``)`\
[`check_predictions`](https://easystats.github.io/performance/reference/check_predictions.html)`(``model``)`
...
\
`model`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``mpg`` ``~`` ``wt`` ``+`` ``cyl`` ``+`` ``gear`` ``+`` ``disp``, data ``=`` ``mtcars``)`\
[`check_predictions`](https://easystats.github.io/performance/reference/check_predictions.html)`(``model``, check_range ``=`` ``TRUE``)`
...
\
`out`` ``<-`` `[`check_model`](https://easystats.github.io/performance/reference/check_model.html)`(``model``)`\
...
\
[`check_autocorrelation`](https://easystats.github.io/performance/reference/check_autocorrelation.html)`(`[`lm`](https://rdrr.io/r/stats/lm.html)`(``formula ``=`` ``wt`` ``~`` ``mpg``, data ``=`` ``mtcars``)``)`\
...
`result`` ``<-`` `[`compare_performance`](https://easystats.github.io/performance/reference/compare_performance.html)`(``lm1``, ``lm2``, ``lm3``, ``lm4``)`\
\
`result`\
...
\
`model`` ``<-`` `[`lmer`](https://rdrr.io/pkg/lme4/man/lmer.html)`(``Reaction`` ``~`` ``Days`` ``+`` ``(``Days`` ``|`` ``Subject``)``, ``sleepstudy``)`\
`result`` ``<-`` `[`check_distribution`](https://easystats.github.io/performance/reference/check_distribution.html)`(``model``)`\
\
`result`\
...
\
`vec`` ``<-`` ``bayestestR``::`[`distribution_poisson`](https://easystats.github.io/bayestestR/reference/distribution.html)`(``n ``=`` ``500``, lambda ``=`` ``2.5``)`\
`result`` ``<-`` `[`check_distribution`](https://easystats.github.io/performance/reference/check_distribution.html)`(``vec``)`\
\
`result`\
...
`  outcome ``=`` ``"y"``,`\
`  exposure ``=`` ``"x"``,`\
`  coords ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(`\
`    x ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``y ``=`` ``5``, x ``=`` ``4``, b ``=`` ``3``, c ``=`` ``3``)``,`\
`    y ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``y ``=`` ``3``, x ``=`` ``3``, b ``=`` ``2``, c ``=`` ``4``)`\
`  ``)`\
`)`\
`# plot comparison between current and required model`\
[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(``dag``)`

![](performance_files/figure-html/unnamed-chunk-31-1.png)

\
`# plot current model specification`\
[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(``dag``, which ``=`` ``"current"``)`

![](performance_files/figure-html/unnamed-chunk-31-2.png)

\
`# plot required model specification`\
[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(``dag``, which ``=`` ``"required"``)`
...
`iris``$``y`` ``<-`` `[`rbinom`](https://rdrr.io/r/stats/Binomial.html)`(`[`nrow`](https://rdrr.io/r/base/nrow.html)`(``iris``)``, size ``=`` ``1``, ``0.3``)`\
\
`folds`` ``<-`` `[`sample`](https://rdrr.io/r/base/sample.html)`(`[`nrow`](https://rdrr.io/r/base/nrow.html)`(``iris``)``, size ``=`` `[`nrow`](https://rdrr.io/r/base/nrow.html)`(``iris``)`` ``/`` ``8``, replace ``=`` ``FALSE``)`\
`test_data`` ``<-`` ``iris``[``folds``, ``]`\
`train_data`` ``<-`` ``iris``[``-``folds``, ``]`\
\
`model`` ``<-`` `[`glm`](https://rdrr.io/r/stats/glm.html)`(``y`` ``~`` ``Sepal.Length`` ``+`` ``Sepal.Width``, data ``=`` ``train_data``, family ``=`` ``"binomial"``)`\
`result`` ``<-`` `[`performance_roc`](https://easystats.github.io/performance/reference/performance_roc.html)`(``model``, new_data ``=`` ``test_data``)`\
\
`result`\
`#> AUC: 37.66%`\
[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(``result``)`
...
\
`# creating models`\
`m1`` ``<-`` `[`glm`](https://rdrr.io/r/stats/glm.html)`(``vs`` ``~`` ``wt`` ``+`` ``mpg``, data ``=`` ``mtcars``, family ``=`` ``"binomial"``)`\
`m2`` ``<-`` `[`glm`](https://rdrr.io/r/stats/glm.html)`(``vs`` ``~`` ``wt`` ``+`` ``am`` ``+`` ``mpg``, data ``=`` ``mtcars``, family ``=`` ``"binomial"``)`\
\
`# comparing their performances using the AUC curve`\
[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(`[`performance_roc`](https://easystats.github.io/performance/reference/performance_roc.html)`(``m1``, ``m2``)``)`
