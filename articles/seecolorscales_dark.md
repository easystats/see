...
`)`\
\
[`theme_set`](https://ggplot2.tidyverse.org/reference/get_theme.html)`(`[`theme_abyss`](https://easystats.github.io/see/reference/theme_abyss.md)`(``legend.position ``=`` ``"bottom"``)``)`
...
`  `[`scale_color_social`](https://easystats.github.io/see/reference/scale_color_social.md)`(``palette ``=`` ``"light"``)`\
\
...
`p1`` ``<-`` `[`ggplot`](https://ggplot2.tidyverse.org/reference/ggplot.html)`(``d1``, `[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``x``, ``y``, colour ``=`` ``group``)``)`` ``+`\
`  `[`geom_line`](https://ggplot2.tidyverse.org/reference/geom_path.html)`(``linewidth ``=`` ``1``)`` ``+`\
`  `[`scale_color_material`](https://easystats.github.io/see/reference/scale_color_material.md)`(``palette ``=`` ``"light"``)`\
\
`p2`` ``<-`` `[`ggplot`](https://ggplot2.tidyverse.org/reference/ggplot.html)`(``iris``, `[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``Sepal.Length``, ``Sepal.Width``, colour ``=`` ``Species``)``)`` ``+`\
`  `[`geom_point2`](https://easystats.github.io/see/reference/geom_point2.md)`(``size ``=`` ``2.5``)`` ``+`\
`  `[`scale_color_material`](https://easystats.github.io/see/reference/scale_color_material.md)`(``palette ``=`` ``"light"``)`\
...
`p1`` ``<-`` `[`ggplot`](https://ggplot2.tidyverse.org/reference/ggplot.html)`(``d1``, `[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``x``, ``y``, colour ``=`` ``group``)``)`` ``+`\
`  `[`geom_line`](https://ggplot2.tidyverse.org/reference/geom_path.html)`(``linewidth ``=`` ``1``)`` ``+`\
`  `[`scale_color_flat`](https://easystats.github.io/see/reference/scale_color_flat.md)`(``palette ``=`` ``"light"``)`\
\
`p2`` ``<-`` `[`ggplot`](https://ggplot2.tidyverse.org/reference/ggplot.html)`(``iris``, `[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``Sepal.Length``, ``Sepal.Width``, colour ``=`` ``Species``)``)`` ``+`\
`  `[`geom_point2`](https://easystats.github.io/see/reference/geom_point2.md)`(``size ``=`` ``2.5``)`` ``+`\
`  `[`scale_color_flat`](https://easystats.github.io/see/reference/scale_color_flat.md)`(``palette ``=`` ``"light"``)`\
...
`p1`` ``<-`` `[`ggplot`](https://ggplot2.tidyverse.org/reference/ggplot.html)`(``d1``, `[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``x``, ``y``, colour ``=`` ``group``)``)`` ``+`\
`  `[`geom_line`](https://ggplot2.tidyverse.org/reference/geom_path.html)`(``linewidth ``=`` ``1``)`` ``+`\
`  `[`scale_color_metro`](https://easystats.github.io/see/reference/scale_color_metro.md)`(``palette ``=`` ``"light"``)`\
\
`p2`` ``<-`` `[`ggplot`](https://ggplot2.tidyverse.org/reference/ggplot.html)`(``iris``, `[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``Sepal.Length``, ``Sepal.Width``, colour ``=`` ``Species``)``)`` ``+`\
`  `[`geom_point2`](https://easystats.github.io/see/reference/geom_point2.md)`(``size ``=`` ``2.5``)`` ``+`\
`  `[`scale_color_metro`](https://easystats.github.io/see/reference/scale_color_metro.md)`(``palette ``=`` ``"light"``)`\
...
`p1`` ``<-`` `[`ggplot`](https://ggplot2.tidyverse.org/reference/ggplot.html)`(``d1``, `[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``x``, ``y``, colour ``=`` ``group``)``)`` ``+`\
`  `[`geom_line`](https://ggplot2.tidyverse.org/reference/geom_path.html)`(``linewidth ``=`` ``1``)`` ``+`\
`  `[`scale_color_see`](https://easystats.github.io/see/reference/scale_color_see.md)`(``palette ``=`` ``"light"``)`\
\
`p2`` ``<-`` `[`ggplot`](https://ggplot2.tidyverse.org/reference/ggplot.html)`(``iris``, `[`aes`](https://ggplot2.tidyverse.org/reference/aes.html)`(``Sepal.Length``, ``Sepal.Width``, colour ``=`` ``Species``)``)`` ``+`\
`  `[`geom_point2`](https://easystats.github.io/see/reference/geom_point2.md)`(``size ``=`` ``2.5``)`` ``+`\
`  `[`scale_color_see`](https://easystats.github.io/see/reference/scale_color_see.md)`(``palette ``=`` ``"light"``)`\
