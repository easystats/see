...
The *see* package is available on CRAN, while its development version is available on GitHub. In order to download the package from GitHub, you will need to have installed the *remotes* package first (`install.packages("remotes")`).
